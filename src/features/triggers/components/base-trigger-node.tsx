    ...
    return (
      ...
      >
        <BaseNode onDoubleClick={onDoubleClick} className="w-[280px] rounded-2xl group">
          <BaseNodeHeader className="bg-blue-500/10 border-b border-blue-500/20 py-4">
            <div className="flex items-center gap-3">
              <div className="size-8 rounded-lg bg-blue-500/20 flex items-center justify-center border border-blue-500/30 shadow-inner group-hover:scale-110 transition-transform duration-300">
                {typeof Icon === "string" ? (
